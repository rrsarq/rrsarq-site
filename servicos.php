...
<main>
    ...
    <section id="engseg">
        ...
        <ul class="lista">
            ...
            <li class="listaItem"><strong>Programa de Prevenção de Riscos Ambientais (<abbr>PPRA</abbr>)</strong> - Elaboração e implementação do PPRA nas empresas, dentro dos requisitos das Normas Regulamentadoras do Ministério do Trabalho</li>
