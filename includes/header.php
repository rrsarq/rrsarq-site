<header>
    ...
    <div id="banner">
        <img class="logo" alt="" src="img/RRSARQ_LOGO_2.1.0_ura_t.png" aria-hidden="true"><div class="nome"> <span class="titulo">rrs.arq |</span><span class="subTitulo"> Arquitetura + Engenharia de Segurança do Trabalho</span></div>
